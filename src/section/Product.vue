          ...
          <div class="row">
              ...
              <div class="col-md-4">
                  <div class="card product-item">
                    <img src="../../public/img/products/product1.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
              ...
              <div class="col-md-4">
                  <div class="card product-item">
                    <img src="../../public/img/products/product2.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
              ...
              <div class="col-md-4">
                  <div class="card product-item">
                    <img src="../../public/img/products/product3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
