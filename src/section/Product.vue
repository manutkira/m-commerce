        ...
        <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
            <div class="col" v-for="product in products" :key="product">
                <div class="card h-100 shadow-sm" v-for="(img, index) in product.images" :key="index"> <img :src="img" class="card-img-top" alt="...">
                    <div class="card-body">
                        <div class="clearfix mb-3"> <span class="float-start badge rounded-pill bg-primary">{{product.brand}}</span> <span class="float-end price-hp">${{product.price}}</span> </div>
                        <h5 class="card-title" v-html="product.description"></h5>
                       <add-to-cart
